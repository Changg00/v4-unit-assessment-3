...
let secretString = myFunc()
 ...
 let lightSwitch = function () {
   ...
   let flipTheSwitch = function() {
     isTheLightOn = !isTheLightOn;
     if(isTheLightOn) return 'The light is on'
...
function inventory() {
  ...
  return {
    ...
    addToProducts(zophir) {
      products.push(zophir)
    },
    deleteFromProducts(prod) {
